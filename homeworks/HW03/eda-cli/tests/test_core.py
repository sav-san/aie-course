...
def test_of_my_flags():
    df = pd.DataFrame({'user_id':[0,1,2,3,4,5,6,7,7,8],
                       'country':["US","US","US","US","US","US","US","US","US","US"],
                       'value':[1213,2354,67342,21321,4123,123,1234,423432,234,7643]})
    ...
    assert quality_flags['has_suspicious_id_duplicates']==True
